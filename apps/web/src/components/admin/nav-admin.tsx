...
import { Activity, ClipboardCheck, HeartPulse, Inbox, SearchX, Sparkles, Tags } from "lucide-react";
...
type Item = {
  ...
  href?: "/admin" | "/admin/salud" | "/admin/revision" | "/admin/beneficios" | "/admin/novedades" | "/admin/auditoria" | "/admin/busquedas";
};
